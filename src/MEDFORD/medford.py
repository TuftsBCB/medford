...
from MEDFORD.objs.bagitHandler import BagItHandler
 ...
 #TODO terminal would not recognize bagithandler without this
...
class MFD():
    ...
    def __init__(self, filename, mode: OutputMode = OutputMode.OTHER, 
                 action: ParserMode = None, base_dir: str = None, 
                 write_json: bool = True, output_path: str = "."):
    ...
    def run_medford(self):
        ...
        # 4
        self.dictionizer = MFD._get_dictionizer(self.macro_definitions, 
                                                self.named_blocks)
    ...
    @classmethod
    def _get_dictionizer(cls, macro_definitions: Dict[str, Macro], 
                         name_dictionary: Dict[str, Block]) -> Dictionizer:
...
ap.add_argument("-m", "--mode", type=OutputMode, choices=list(OutputMode), 
