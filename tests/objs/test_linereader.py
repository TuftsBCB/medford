...
def comment_ex_fixture():
    example_lines = ["#Comment Line", "# Comment Line"]
    invalid_lines = ["Not a # Comment Line"]
...
def macro_ex_fixture():
    example_lines = [
        "`@Name value",
        "`@Name value 1 value 2`@Name value1 # inline`@Name `@use",
    ]
    invalid_lines = [
        "`@ Not a macro",
        "'@Not a macro",
...
def test_detect_noveldetail(
    noveldetail_ex_fixture, macro_ex_fixture, comment_ex_fixture
):
